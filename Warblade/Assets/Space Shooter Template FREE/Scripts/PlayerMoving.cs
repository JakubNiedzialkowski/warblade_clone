...
public class PlayerMoving : MonoBehaviour {
    ...
    private void FixedUpdate()
    {
        if (controlIsActive)
        {
                dirX = CrossPlatformInputManager.GetAxisRaw("Horizontal") * moveSpeed * Time.deltaTime;
                transform.position = new Vector3(transform.position.x+dirX, transform.position.y , 0f);
